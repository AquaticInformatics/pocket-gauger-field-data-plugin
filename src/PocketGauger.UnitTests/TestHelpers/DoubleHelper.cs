...
namespace PocketGauger.UnitTests.TestHelpers
{
    public static class DoubleHelper
    {
        ...
        private struct DoubleInt64Union
        {
            ...
            public bool IsNegative { get { return (Int64 >> 63) != 0L; } }
        }
        ...
        public static int Compare(double firstValue, double secondValue)
        {
        ...
        public static bool AreEqual(double? firstValue, double? secondValue)
        {
            ...
            return AreEqual(firstValue.Value, secondValue.Value);
        }
    }
}
